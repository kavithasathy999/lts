...
<<<<<<< HEAD
        ...
        <StatCard label="Total Visitors (Regs)" value={stats.totalVisitors || 0} icon="fas fa-users" color="#36b9cc" onClick={() => navigate("/admin/visitor-registrations", { state: { statusFilter: "all" } })} />
        <StatCard label="Confirmed Visitors"  value={stats.approvedVisitors || 0} icon="fas fa-user-check" color="#1cc88a" onClick={() => navigate("/admin/visitor-registrations", { state: { statusFilter: "approved" } })} />
        <StatCard label="Visitor Pending Requests" value={stats.pendingVisitors || 0} icon="fas fa-user-clock" color="#f39c12" onClick={() => navigate("/admin/visitor-registrations", { state: { statusFilter: "pending" } })} />
